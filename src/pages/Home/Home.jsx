...
export default function Home() {
  return (
    <>
      ...
      <div
        id="materiais"
        className="mx-4 mt-24 h-full items-center flex flex-col space-y-8"
      >
      ...
      <div
        id="legislação"
        className="mt-12 p-6  h-full items-center flex flex-col sm:flex-col space-y-8"
      >
        <div className="mx-4 sm:w-2/3 sm:p-8 mx-auto">
          ...
          <p className="mt-4 font-sans text-xl text-gray-700 text-center">
            A produção e o descarte de equipamentos de informática estão
            sujeitos a uma série de normas e leis ambientais que visam minimizar
            o impacto negativo desses dispositivos no meio ambiente. Essas
            regulamentações estabelecem diretrizes para a fabricação
            responsável, o uso sustentável dos recursos naturais e o descarte
            adequado dos equipamentos eletrônicos. Conhecer e cumprir essas leis
            é fundamental para garantir a sustentabilidade da indústria de
            tecnologia e preservar o meio ambiente. Aqui estão algumas normas e
            leis associadas ao tema:
          </p>
        </div>
      ...
      <div id="contato" className="flex justify-center">
        <div className="w-2/3 mt-24">
          <h1 className="mb-6 font-sans text-3xl font-extrabold text-gray-700 text-center">
            Contato
          </h1>
          <Contato />
        </div>
