  ...
  return (
    ...
    <div id="lixoEletronico" className="mt-24 h-full items-center flex flex-col sm:flex-col space-y-8">
        <div className="space-y-8 sm:w-1/2 sm:p-8">
            ...
            Conheça os principais materiais utilizados na fabricação de equipamentos de informática e seu impacto ambiental    </p>
            </div>
    ...
    <div>
        ...
        <div id="maisInfo" className="mt-24 h-full items-center flex flex-col sm:flex-col space-y-8 text-center ml-12 mr-12">
