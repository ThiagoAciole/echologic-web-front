...
export default function CardImagemDireita() {
  return (
    <div className="flex space-x-5 mt-20 flex-wrap-reverse md:justify-between sm:justify-center items-center" id={styles.cardImagemDireitaResponsividade}>
        <div className=" flex flex-col justify-center md:w-7/12">
            ...
            <p className="pt-10 pb-5 lg:text-xl text-sm font-sans">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate cum rerum in facilis dolores placeat totam illo, suscipit eligendi vitae?</p>
        </div>
        <div className=''>
